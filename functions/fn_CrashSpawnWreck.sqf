...
YEIIJ_crashWreck = YEIIJ_YEIIJ_crashWreckCls createVehicle YEIIJ_crashDefPos;
YEIIJ_crashWreck setPos YEIIJ_crashSpwnPos;

YEIIJ_crashAmoBox = YEIIJ_YEIIJ_crashAmoBoxCls createVehicle YEIIJ_crashDefPos;
...
YEIIJ_crashWepBox = YEIIJ_YEIIJ_crashWepBoxCls createVehicle YEIIJ_crashDefPos;
...
YEIIJ_crashSmoke = YEIIJ_YEIIJ_crashSmokeCls createVehicle [0,0,0];
